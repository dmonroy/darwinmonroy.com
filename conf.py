...
BLOG_AUTHOR = "Darwin Monroy"  # (translatable)
BLOG_TITLE = "Darwin Monroy"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://darwinmonroy.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://darwinmonroy.com/"
BLOG_EMAIL = "contact@darwinmonroy.com"
BLOG_DESCRIPTION = "The place where Darwin shares his ideas"  # (translatable)
